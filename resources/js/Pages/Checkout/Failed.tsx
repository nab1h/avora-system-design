...
export default function CheckoutFailed({ transaction }: CheckoutResultProps) {
    ...
    return (
        <>
            <Head title={translate({ ar: "فشل الدفع", en: "Payment failed" })} />
                ...
                <Container className="space-y-6">
                    ...
                    <Card variant="elevated" padding="lg" className="mx-auto max-w-2xl text-center">
                        <CardHeader>
                            ...
                            <CardTitle>
                                {translate({ ar: "الدفع لم يكتمل", en: "Payment was not completed" })}
                            </CardTitle>
                        </CardHeader>
                        ...
                        <CardContent className="space-y-5">
                            ...
                            <div className="flex flex-wrap justify-center gap-3">
                                <Link href={route("home")}>
                                    <Button>{translate({ ar: "جرب مرة تانية", en: "Try again" })}</Button>
                                </Link>
