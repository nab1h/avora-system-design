...
const paths: Record<DashboardIconName, JSX.Element> = {
    ...
    orders: <><path d="M6 3h12l2 4-2 4H6L4 7l2-4Z" /><path d="M6 11v8a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-8M9 15h6" /></>,
    products: <><path d="m12 3 8 4.5v9L12 21l-8-4.5v-9L12 3Z" /><path d="m4.5 7.5 7.5 4 7.5-4M12 21v-9.5" /></>,
    purchases: <><path d="M6 7h15l-2 8H8L6 7Z" /><path d="M6 7 5 3H2" /><circle cx="9" cy="20" r="1.5" /><circle cx="18" cy="20" r="1.5" /><path d="M9 11h7" /></>,
    customers: <><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M22 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75" /></>,
    reports: <><path d="M4 20V10M10 20V4M16 20v-7M22 20H2" /></>,
    calendar: <><rect x="3" y="5" width="18" height="16" rx="2" /><path d="M16 3v4M8 3v4M3 10h18" /></>,
    forms: <><path d="M4 4h16v16H4zM8 9h8M8 13h5M8 17h3" /></>,
    ...
    payments: <><rect x="3" y="6" width="18" height="12" rx="2" /><path d="M3 10h18M7 15h4M15 15h2" /></>,
    ...
    sales: <><path d="M3 17 9 11l4 4 8-9" /><path d="M15 6h6v6" /></>,
...
export function DashboardIcon({ name, className = 'h-5 w-5', ...props }: DashboardIconProps) {
    return (
        <svg
            aria-hidden="true"
            viewBox="0 0 24 24"
