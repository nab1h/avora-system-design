            ...
            <section className="avora-brand-gradient relative hidden overflow-hidden p-12 text-white lg:flex lg:flex-col lg:justify-between">
                ...
                <Link href="/" className="relative flex items-center gap-3">
                    {logoUrl ? (
                        ...
                        <span className="avora-text-primary grid h-11 w-11 place-items-center rounded-2xl bg-white text-xl font-black">
                ...
                <div className="relative max-w-lg">
                    ...
                    <h2 className="text-4xl font-black leading-tight">
                        {translate({
                            ar: "إدارة أعمالك تبدأ من مكان واحد.",
                            en: "Run your business from one beautiful place.",
                        })}
                    </h2>
                    <p className="mt-5 text-base leading-8 text-white/75">
                        {translate({
                            ar: "لوحة تحكم سريعة وآمنة، مصممة لتساعدك على متابعة كل التفاصيل واتخاذ قرارات أفضل.",
                            en: "A fast, secure workspace designed to help you track every detail and make better decisions.",
                        })}
                    </p>
                </div>
                ...
                <header className="flex h-20 items-center justify-between px-5 sm:px-8">
                    ...
                    >
                        {logoUrl ? (
                            ...
                            <span className="avora-button-primary grid h-9 w-9 place-items-center rounded-xl font-black text-white">
                                {appName.charAt(0).toUpperCase()}
                            </span>
                        )}
